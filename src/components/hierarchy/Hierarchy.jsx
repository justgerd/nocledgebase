...
export function Hierarchy(props) {
  ...
  return (
    <div class="hierarchy">
      <svg
        viewBox={`${tree.viewBox.baseVal.x},${tree.viewBox.baseVal.y},${tree.viewBox.baseVal.width},${tree.viewBox.baseVal.height}`}
        style={tree.style.cssText}
        font-size={10}
        dangerouslySetInnerHTML={{__html: tree.innerHTML }}
      ></svg>
    </div>
  )
}
